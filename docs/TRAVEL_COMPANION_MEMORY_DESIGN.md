# 旅芽 · by FareSniper「出行旅伴与记忆手帐」产品方案

## 1. 产品定义

“旅芽”是用户看到的产品名：从一个刚刚发芽的出行念头开始，陪伴用户完成计划、决策、出发和回忆整理。

FareSniper 暂时保留为机票查询、比较、价格观察和提醒能力的技术品牌。这样无需立刻改仓库、接口和既有认知，也为产品从机票扩展到完整出行陪伴留出空间。

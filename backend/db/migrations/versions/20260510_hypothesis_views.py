"""create H1-H6 hypothesis SQL views for experiment tracking.

Revision ID: 20260510_hypothesis_views
Revises: 20260509_cps_settlement
...
revision: str = "20260510_hypothesis_views"
down_revision: Union[str, Sequence[str], None] = "20260509_cps_settlement"
...
_DROP_VIEWS = [
    "v_h6_explore_traffic",
    "v_h5_freshness_nps",
    "v_h4_pref_retention",
    "v_h3_jump_rate",
    "v_h2_advice_adoption",
    "v_h1_chat_vs_form",
]
